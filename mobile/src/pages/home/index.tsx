...
const Home = () => {
  ...
  function navigateToPoints(){
    navigation.navigate('CollectPoints', filters);
  }
      ...
      >
        ...
        <View style={styles.footer}>
          <TextInput style={styles.input} placeholder="Cidade"
            onChangeText={text => setFilters({...filters, cityToFilter: text})}
          />
          <TextInput style={styles.input} placeholder="Cód. Postal"
            onChangeText={text => setFilters({...filters, zipcodeToFilter: text})}
          />
